...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if(cached3DBattery) {
      return Promise.resolve(onLoadItem(cached3DBattery.clone()));
    }

    let mtl = require('./battery.mtl');
    let obj = require('./battery.obj');

    return loadObjWithMaterial(mtl, obj, '')
      .then(object => {
        cached3DBattery = object;
        return onLoadItem(cached3DBattery.clone())
      })
  }
