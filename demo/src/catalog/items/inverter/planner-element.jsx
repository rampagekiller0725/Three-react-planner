...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if(cached3DInverter) {
      return Promise.resolve(onLoadItem(cached3DInverter.clone()));
    }

    let mtl = require('./inverter.mtl');
    let obj = require('./inverter.obj');

    return loadObjWithMaterial(mtl, obj, '')
      .then(object => {
        cached3DInverter = object;
        return onLoadItem(cached3DInverter.clone())
      })
  }
