...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if(cached3DSolarPanel) {
      return Promise.resolve(onLoadItem(cached3DSolarPanel.clone()));
    }

    let mtl = require('./Solar_Panel.mtl');
    let obj = require('./Solar_Panel.obj');

    return loadObjWithMaterial(mtl, obj, '')
      .then(object => {
        cached3DSolarPanel = object;
        return onLoadItem(cached3DSolarPanel.clone())
      })
  }
